// client/src/app/dashboard/Commoncomponents/EditProduct.jsx
...
const EditProduct = ({ selectedProduct, weights, setWeights, benefits, setBenefits, faqs, setFaqs, handleUpdateProduct, setSelectedMenu }) => {
  const [form] = Form.useForm();

  // useEffect का यूज करके selectedProduct का डेटा फॉर्म में लोड करें
  useEffect(() => {
    if (selectedProduct) {
      form.setFieldsValue({
        ...selectedProduct,
  ...
  }, [selectedProduct, weights, benefits, faqs, form]);
